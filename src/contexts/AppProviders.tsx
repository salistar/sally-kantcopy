...
const DARK: Palette = {
  isDark: true,
  bg: '#0A0A1A',
  bgGradient: ['#0A0A1A', '#042F3A', '#083344'] as const,
  card: 'rgba(26, 22, 50, 0.85)',
  cardGradient: ['#1E1B3A', '#2A1F4D'] as const,
  text: '#F3F4F6',
  textSecondary: '#9CA3AF',
  accent: '#0D9488',
  accentGradient: ['#0D9488', '#14B8A6'] as const,
  danger: '#EF4444',
  success: '#10B981',
  gold: '#F59E0B',
  border: 'rgba(255,255,255,0.08)',
  headerGradient: ['#042F3A', '#134E4A', '#083344'] as const,
};
...
const K_THEME = '@concentration/theme-mode';
const K_LOCALE = '@concentration/locale';
