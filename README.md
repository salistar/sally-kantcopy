...
> Kant Copy — variante de copy/match marocaine, 2 à 4 joueurs.

[![Build APK](https://github.com/salistar/sally-kantcopy/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-kantcopy/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-kantcopy/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-kantcopy/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.kantcopy` |
| **Bundle ID iOS** | `com.sallycards.kantcopy` |
...
- Variante locale du jeu de cartes Kant (copie / aligne)
- 1v1 ou 2v2 en équipe
- Multi-joueur en ligne (Socket.IO) + voice WebRTC
- Bots disponibles avec niveau ajustable
- Animations cartes, son, haptics
- 5 langues incluant Darija
...
```powershell
git clone https://github.com/salistar/sally-kantcopy.git
cd sally-kantcopy
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-kantcopy
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.kantcopy 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.kantcopy/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore kantcopy.keystore -alias kantcopy `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
KANTCOPY_UPLOAD_STORE_FILE=kantcopy.keystore
KANTCOPY_UPLOAD_KEY_ALIAS=kantcopy
KANTCOPY_UPLOAD_STORE_PASSWORD=<password>
KANTCOPY_UPLOAD_KEY_PASSWORD=<password>
